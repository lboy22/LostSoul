...
public class bridgeBuild : MonoBehaviour
{
    ...
    void Start() 
    {
        ...
        bottomLeftCoords = new Vector3(xCoord, yCoord, 0) - new Vector3(5.0f, 7.0f, 25.0f);
        topRightCoords = new Vector3(xCoord, yCoord, 0) + new Vector3(5.0f, 7.0f, 25.0f);
    ...
    void Update()
    {
        ...
        if(Input.GetMouseButtonDown(0) ) {
            thisObject.transform.position = new Vector3(-20.0f, 1.5f, 1.0f);
            print ("updated");
            PlayerPrefs.SetInt("bridgeLeft", -21);
            PlayerPrefs.SetInt("bridgeRight", -18);
